...
| [research.md](research.md) | Phase-0 decisions and alternatives | Asking *why* a decision was made |
...
- **Contract layer**: `tinio-core` traits (`Storage`, `Cleanup`) — backend-agnostic.
